{host, ...}: let
  ...
  defaultWindowRules = [
        "tag +file-manager, class:^(org.gnome.Nautilus|[Pp]cmanfm-qt)$"
        "tag +terminal, class:^(org.wezfurlong.wezterm|Alacritty|kitty|kitty-dropterm)$"
        ...
        "tag +settings, class:^(nwg-look|[Yy]ad)$"
